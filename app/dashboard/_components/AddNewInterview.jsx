...
function AddNewInterview() {
    ...
    const onSubmit = async(e) => {
        setLoading(true)
        e.preventDefault()
        const InputPrompt = "Job position:" +jobPosition+", Job Description: " +jobDesc+ ", Years of Experience: " +jobExperience+ ",Depends on Job Position,Job Description,Years of experience give us " +process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+"interview question in JSON format,question and answer are the fields for the JSON format";
    ...
    <DialogHeader>
      ...
      <DialogDescription>
        ...
        <div>
            ...
            <h2>Add details about your job position,experience and description</h2>
